...
# ✅ 3. 유사도 계산 함수 (Cosine Similarity)
def compute_similarity(img1_path: str, img2_path: str, threshold: float = 0.9):
...
if __name__ == "__main__":
    img_path1 = "data/images/dataset/ex1.jpeg"
    img_path2 = "data/images/dataset/ex2.jpeg"
    
    compute_similarity(img_path1, img_path2, threshold=0.9)
